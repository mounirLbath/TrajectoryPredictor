...
class FlowModel(nn.Module):
    def __init__(self, hidden=256, type_dim=16, time_dim=32, width=512, token_dim=128):
        super().__init__()
    ...
    def forward(self, x, t, history, type_id, lanes, lane_mask, neighbors, neighbor_mask, neighbor_type):
        ...
        road = self.attend(self.lane_attention, query, self.lane_token(self.lane_points(lanes).max(2).values), lane_mask, self.null_lane)
